...
export class CashScriptParser extends Parser {
	...
	public functionDefinition(): FunctionDefinitionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la === CashScriptParser.T__17 || _la === CashScriptParser.T__18 || ((((_la - 47)) & ~0x1F) === 0 && ((1 << (_la - 47)) & ((1 << (CashScriptParser.T__46 - 47)) | (1 << (CashScriptParser.T__47 - 47)) | (1 << (CashScriptParser.T__48 - 47)) | (1 << (CashScriptParser.T__49 - 47)) | (1 << (CashScriptParser.T__50 - 47)) | (1 << (CashScriptParser.T__51 - 47)) | (1 << (CashScriptParser.Bytes - 47)) | (1 << (CashScriptParser.Identifier - 47)))) !== 0)) {
				{
				{
				this.state = 91;
				this.statement();
	...
	public parameterList(): ParameterListContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 47)) & ~0x1F) === 0 && ((1 << (_la - 47)) & ((1 << (CashScriptParser.T__46 - 47)) | (1 << (CashScriptParser.T__47 - 47)) | (1 << (CashScriptParser.T__48 - 47)) | (1 << (CashScriptParser.T__49 - 47)) | (1 << (CashScriptParser.T__50 - 47)) | (1 << (CashScriptParser.T__51 - 47)) | (1 << (CashScriptParser.Bytes - 47)))) !== 0)) {
				{
				this.state = 100;
				this.parameter();
				this.state = 105;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 5:
						...
						this.state = 267;
						(_localctx as BinaryOpContext)._op = this.match(CashScriptParser.T__42);
						this.state = 268;
					...
					case 7:
						...
						this.state = 273;
						(_localctx as BinaryOpContext)._op = this.match(CashScriptParser.T__43);
						this.state = 274;
					...
					case 8:
						...
						this.state = 276;
						(_localctx as BinaryOpContext)._op = this.match(CashScriptParser.T__44);
						this.state = 277;
	...
	public static readonly _serializedATN: string =
		...
		"\xF1\n\x16\f\x16\x0E\x16\xF4\v\x16\x03\x16\x05\x16\xF7\n\x16\x05\x16\xF9" +
		"\n\x16\x03\x16\x03\x16\x03\x16\x03\x16\x05\x16\xFF\n\x16\x03\x16\x03\x16" +
		"\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16" +
		"\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16" +
		"\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16" +
		"\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16" +
		"\x03\x16\x07\x16\u0128\n\x16\f\x16\x0E\x16\u012B\v\x16\x03\x17\x03\x17" +
		"\x03\x17\x03\x17\x03\x17\x05\x17\u0132\n\x17\x03\x18\x03\x18\x05\x18\u0136" +
		...
		"\x03\x02\x02\x02\x18\x89\x03\x02\x02\x02\x1A\x8B\x03\x02\x02\x02\x1C\x91" +
		"\x03\x02\x02\x02\x1E\x9A\x03\x02\x02\x02 \x9F\x03\x02\x02\x02\"\xA7\x03" +
		"\x02\x02\x02$\xAD\x03\x02\x02\x02&\xB6\x03\x02\x02\x02(\xB9\x03\x02\x02" +
		"\x02*\xFE\x03\x02\x02\x02,\u0131\x03\x02\x02\x02.\u0133\x03\x02\x02\x02" +
		"0\u0137\x03\x02\x02\x0224\x05\x04\x03\x0232\x03\x02\x02\x0247\x03\x02" +
		...
		"IJ\x077\x02\x02J\v\x03\x02\x02\x02KL\t\x02\x02\x02L\r\x03\x02\x02\x02" +
		"MN\x07\r\x02\x02NO\x07B\x02\x02OP\x05\x12\n\x02PT\x07\x0E\x02\x02QS\x05" +
		...
		"\x03\x02\x02\x02YZ\x07\x10\x02\x02Z[\x07B\x02\x02[\\\x05\x12\n\x02\\`" +
		...
		"\x02t\x13\x03\x02\x02\x02uv\x050\x19\x02vw\x07B\x02\x02w\x15\x03\x02\x02" +
		...
		"\x02\x81\x80\x03\x02\x02\x02\x82\x17\x03\x02\x02\x02\x83\x8A\x05\x1A\x0E" +
		"\x02\x84\x8A\x05\x1C\x0F\x02\x85\x8A\x05\x1E\x10\x02\x86\x8A\x05 \x11" +
		"\x02\x87\x8A\x05\"\x12\x02\x88\x8A\x05$\x13\x02\x89\x83\x03\x02\x02\x02" +
		"\x89\x84\x03\x02\x02\x02\x89\x85\x03\x02\x02\x02\x89\x86\x03\x02\x02\x02" +
		"\x89\x87\x03\x02\x02\x02\x89\x88\x03\x02\x02\x02\x8A\x19\x03\x02\x02\x02" +
		"\x8B\x8C\x050\x19\x02\x8C\x8D\x07B\x02\x02\x8D\x8E\x07\f\x02\x02\x8E\x8F" +
		"\x05*\x16\x02\x8F\x90\x07\x04\x02\x02\x90\x1B\x03\x02\x02\x02\x91\x92" +
		"\x050\x19\x02\x92\x93\x07B\x02\x02\x93\x94\x07\x12\x02\x02\x94\x95\x05" +
		"0\x19\x02\x95\x96\x07B\x02\x02\x96\x97\x07\f\x02\x02\x97\x98\x05*\x16" +
		"\x02\x98\x99\x07\x04\x02\x02\x99\x1D\x03\x02\x02\x02\x9A\x9B\x07B\x02" +
		"\x02\x9B\x9C\x07\f\x02\x02\x9C\x9D\x05*\x16\x02\x9D\x9E\x07\x04\x02\x02" +
		"\x9E\x1F\x03\x02\x02\x02\x9F\xA0\x07\x14\x02\x02\xA0\xA1\x07\x11\x02\x02" +
		"\xA1\xA2\x07@\x02\x02\xA2\xA3\x07\b\x02\x02\xA3\xA4\x05*\x16\x02\xA4\xA5" +
		"\x07\x13\x02\x02\xA5\xA6\x07\x04\x02\x02\xA6!\x03\x02\x02\x02\xA7\xA8" +
		"\x07\x14\x02\x02\xA8\xA9\x07\x11\x02\x02\xA9\xAA\x05*\x16\x02\xAA\xAB" +
		"\x07\x13\x02\x02\xAB\xAC\x07\x04\x02\x02\xAC#\x03\x02\x02\x02\xAD\xAE" +
		"\x07\x15\x02\x02\xAE\xAF\x07\x11\x02\x02\xAF\xB0\x05*\x16\x02\xB0\xB1" +
		"\x07\x13\x02\x02\xB1\xB4\x05\x16\f\x02\xB2\xB3\x07\x16\x02\x02\xB3\xB5" +
		"\x05\x16\f\x02\xB4\xB2\x03\x02\x02\x02\xB4\xB5\x03\x02\x02\x02\xB5%\x03" +
		"\x02\x02\x02\xB6\xB7\x07B\x02\x02\xB7\xB8\x05(\x15\x02\xB8\'\x03\x02\x02" +
		"\x02\xB9\xC5\x07\x11\x02\x02\xBA\xBF\x05*\x16\x02\xBB\xBC\x07\x12\x02" +
		"\x02\xBC\xBE\x05*\x16\x02\xBD\xBB\x03\x02\x02\x02\xBE\xC1\x03\x02\x02" +
		...
		"\x02\xC5\xC6\x03\x02\x02\x02\xC6\xC7\x03\x02\x02\x02\xC7\xC8\x07\x13\x02" +
		"\x02\xC8)\x03\x02\x02\x02\xC9\xCA\b\x16\x01\x02\xCA\xCB\x07\x11\x02\x02" +
		"\xCB\xCC\x05*\x16\x02\xCC\xCD\x07\x13\x02\x02\xCD\xFF\x03\x02\x02\x02" +
		"\xCE\xCF\x050\x19\x02\xCF\xD0\x07\x11\x02\x02\xD0\xD3\x05*\x16\x02\xD1" +
		"\xD2\x07\x12\x02\x02\xD2\xD4\x05*\x16\x02\xD3\xD1\x03\x02\x02\x02\xD3" +
		"\xD4\x03\x02\x02\x02\xD4\xD6\x03\x02\x02\x02\xD5\xD7\x07\x12\x02\x02\xD6" +
		...
		"\x02\xFF\u0129\x03\x02\x02\x02\u0100\u0101\f\x0F\x02\x02\u0101\u0102\t" +
		"\x06\x02\x02\u0102\u0128\x05*\x16\x10\u0103\u0104\f\x0E\x02\x02\u0104" +
		"\u0105\t\x07\x02\x02\u0105\u0128\x05*\x16\x0F\u0106\u0107\f\r\x02\x02" +
		"\u0107\u0108\t\b\x02\x02\u0108\u0128\x05*\x16\x0E\u0109\u010A\f\f\x02" +
		"\x02\u010A\u010B\t\t\x02\x02\u010B\u0128\x05*\x16\r\u010C\u010D\f\v\x02" +
		"\x02\u010D\u010E\x07-\x02\x02\u010E\u0128\x05*\x16\f\u010F\u0110\f\n\x02" +
		"\x02\u0110\u0111\x07\x06\x02\x02\u0111\u0128\x05*\x16\v\u0112\u0113\f" +
		...
		"\u0115\x03\x02\x02\x02\u0127\u0118\x03\x02\x02\x02\u0127\u011B\x03\x02" +
		"\x02\x02\u0127\u011F\x03\x02\x02\x02\u0127\u0121\x03\x02\x02\x02\u0128" +
		"\u012B\x03\x02\x02\x02\u0129\u0127\x03\x02\x02\x02\u0129\u012A\x03\x02" +
		"\x02\x02\u012A+\x03\x02\x02\x02\u012B\u0129\x03\x02\x02\x02\u012C\u0132" +
		"\x078\x02\x02\u012D\u0132\x05.\x18\x02\u012E\u0132\x07=\x02\x02\u012F" +
		"\u0132\x07>\x02\x02\u0130\u0132\x07?\x02\x02\u0131\u012C\x03\x02\x02\x02" +
		"\u0131\u012D\x03\x02\x02\x02\u0131\u012E\x03\x02\x02\x02\u0131\u012F\x03" +
		"\x02\x02\x02\u0131\u0130\x03\x02\x02\x02\u0132-\x03\x02\x02\x02\u0133" +
		"\u0135\x07:\x02\x02\u0134\u0136\x079\x02\x02\u0135\u0134\x03\x02\x02\x02" +
		"\u0135\u0136\x03\x02\x02\x02\u0136/\x03\x02\x02\x02\u0137\u0138\t\v\x02" +
		"\x02\u01381\x03\x02\x02\x02\x1B5DGT`koq|\x81\x89\xB4\xBF\xC3\xC5\xD3\xD6" +
		"\xF2\xF6\xF8\xFE\u0127\u0129\u0131\u0135";
